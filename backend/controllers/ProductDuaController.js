...
export const getAllProduct = asyncHandler(async(req, res) => {
    ...
    const count = await ProductDua.countDocuments({...keyword});
    const products = await ProductDua.find({...keyword})
        .limit(pageSize)
...
export const getSingleproduct = asyncHandler(async (req, res) => {
    const product = await ProductDua.findById(req.params.id);
...
export const updateProduct = asyncHandler(async (req, res) => {
    let product = await ProductDua.findById(req.params.id);
